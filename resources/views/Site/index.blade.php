...
@section('content')
    <main>
		...
		<div class="bg_color_1 padding_t_20">
			<div style="height: auto; background: #77d6ce !important;" class="hero_home version_3">
				<div style="padding: 3% 4%;" class="content">
					...
					<a href="{{ route('site.medical_guide') }}" class="btn_1 medium">Acessar</a>
				</div>
			</div>
		</div>
		...
		{{-- <div class="container margin_30_30">
			<div class="row">
				<div class="col-md-3">
					<a class="box_feat_about" style="padding: 20px 12px 20px 12px; height: 226px !important;" href="#0">
						<i class="pe-7s-id"></i>
						<h3>
							CARTEIRINHA DIGITAL
						</h3>
						<p>
							Clique no botão abaixo e acesse a sua carteirinha digital e a de seus dependentes
						</p>
					</a>
				</div>
				<div class="col-md-3">
					<a class="box_feat_about" style="padding: 20px 12px 20px 12px; height: 226px !important;" href="#0">
						...
						<p>Clique aqui e encontre conteúdos produzidos especialmente para você e sua família</p>
					</a>
				</div>
				<div class="col-md-3">
					<a class="box_feat_about" style="padding: 20px 12px 20px 12px; height: 226px !important;" href="#0">
						...
						<p>Acesse nossos sistemas e confira dados sobre autorização e faturamento</p>
					</a>
				</div>
				<div class="col-md-3">
					<a class="box_feat_about" style="padding: 20px 12px 20px 12px; height: 226px !important;" href="#0">
						...
						<div class="col-md-4">
							<div class="box_list home">
								...
								<div class="wrapper card-featured-post p-t-10 p-b-10">
									{{-- <small>
										Autoria: {{ HelpAdmin::completName($featured_post->Post->Author) }}
									</small> --}}
									<h3>
										<a href="{{ route('site.posts.detail', $featured_post->Post->id) }}">
