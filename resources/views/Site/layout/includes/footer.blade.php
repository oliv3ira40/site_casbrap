            ...
            <div class="container margin_30_30 p-b-10">
                <div class="row">
                    {{-- <div class="col-md-12">
                        <p>
                            <a href="{{ route('site.index') }}" title="Findoctor">
                                <img src="{{ asset(HelpAdmin::getStorageUrl().HelpAppearanceSetting::getLogoWhiteBackground()->logo_for_white_background) }}" alt="" width="163" height="36" class="img-fluid">
                            </a>
                        </p>
                    </div> --}}
                    <div class="col-md-4">
						...
						<p class="p-t-10 m-b-10">
							...
							<br>Prédio da Casembrapa. Brasília-DF
						</p>
						<p class="m-b-10">
							Correspondência: Caixa Postal 10.811,
							<br>CEP 70306-970
						</p>
                    </div>
                    <div class="col-md-4">
                        ...
                        <ul class="links">
                            <li>
								<a href="{{ route('site.beneficiary_form') }}">
									Formulários Cadastrais
								</a>
							</li>
                            <li>
								<a href="{{ route('site.duplicate_billet') }}">
									2ª via de boleto
								</a>
							</li>
                            <li>
						...
						<a class="display-block p-b-10" href="{{ route('site.user.validate_cpf', ['target'=>'digital_wallet']) }}">
							<strong>
								Carteirinha digital
							</strong>
						</a>
						<a class="display-block p-b-10" href="{{ route('adm.email_entry') }}">
							<strong>
								Colaboradores
							</strong>
						</a>
                    ...
                    <div class="col-md-4">
						...
						<p align="justify">
							A Ouvidoria não substitui os demais canais de contato. Sua solicitação/dúvida deve ser iniciada na Central de Atendimento
						</p>

						<a class="display-block p-b-10" href="{{ route('site.call_center') }}">
							<strong>
								CENTRAL DE ATENDIMENTO
							</strong>
						</a>

						<a class="display-block p-b-10" href="{{ route('site.ombudsman') }}">
							<strong>
								OUVIDORIA
							</strong>
						</a>
                        ...
                        <ul class="display-inline-flex mb-0">
                            <li class="p-r-10 li_ans_branca">
								<a href="http://www.ans.gov.br">
									<img class="logo_ans_branca" src="{{ asset('logos/ans-branca.png') }}">
								</a>
							</li>
                            <li style="padding-top: 15px;" class="p-r-10 li_ans_casembrapa">
								<a href="http://www.ans.gov.br">
									<img class="logo_ans_casembrapa" src="{{ asset('logos/ans-casembrapa.png') }}">
								</a>
							</li>
