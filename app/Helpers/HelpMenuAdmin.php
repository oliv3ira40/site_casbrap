		...
		public static function SideMenu()
		{
			...
			if (HelpAdmin::IsUserDeveloper()) {
				return [
					...
					// MENU Intranet
					[
						'permission'=>'adm.menu_intranet',
						'name_menu'=>'Arquivos Intranet',
					],
					// Intranet
					[
						'permission'=>'adm.menu_intranet',
						...
						'sub_menu'=>[
							[
								'label'=>'Regulamento',
								'url'=>'adm.file_1',
								'active_page'=>(in_array($action, ['adm.file_1'])) ? 'active-page' : '',
							],
							[
								'label'=>'Estatuto Social',
								'url'=>'adm.file_2',
								'active_page'=>(in_array($action, ['adm.file_2'])) ? 'active-page' : '',
							],
							[
								'label'=>'Quadro Pessoal',
								'url'=>'adm.file_3',
								'active_page'=>(in_array($action, ['adm.file_3'])) ? 'active-page' : '',
							],
							[
								'label'=>'Ramais',
								'url'=>'adm.file_4',
								'active_page'=>(in_array($action, ['adm.file_4'])) ? 'active-page' : '',
							],
						],
						'line'=>false,
					],
			...
			} elseif (HelpAdmin::IsUserCollaborator2()) {
				return [
					// Página inicial
					[
						'permission'=>'adm.index',
