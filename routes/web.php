...
Route::group(['middleware' => ['VerifyUserPermissions', 'CheckDefinitivePassword']], function(){
    ...
    // ADMIN
        ...
        // FILES
            Route::get('adm/arquivos-disponiveis', 'Admin\FileController@allFiles')->name('adm.files.all_files');
        ...
        // POSTS // MENU permission adm.menu_posts
            Route::get('adm/noticias/lista', 'Admin\Site\Post\PostController@list')->name('adm.posts.list');
        ...
        // CategoryPost // MENU adm.menu_category_post
            Route::get('adm/categoria-noticia/lista', 'Admin\Site\Post\CategoryPostController@list')->name('adm.categories_posts.list');
        ...
        // TagPost // MENU adm.menu_tag_post
            Route::get('adm/tag-noticia/lista', 'Admin\Site\Post\TagPostController@list')->name('adm.tags_posts.list');
    ...
    // Site
        ...
        // USER
            Route::get('/validando-usuario/{target?}/{evaluation_id?}', 'Site\UserController@validateCpf')
        ...
        // Statics
            ...
            Route::get('conselho-de-administração', 'Site\SiteController@administrativeCouncil')
                ->name('site.administrative_council');
            Route::get('conselho-fiscal', 'Site\SiteController@fiscalCouncil')
                ->name('site.fiscal_council');
            Route::get('diretoria-executiva', 'Site\SiteController@executiveBoard')
                ->name('site.executive_board');
            Route::get('diretoria-executiva/alan-augusto-dos-reis', 'Site\SiteController@executiveBoardAlan_Adr')
                ->name('site.executive_board.alan_adr');
            Route::get('diretoria-executiva/euripedes-rosa-do-nascimento-junior', 'Site\SiteController@executiveBoardEuripedes_Rdnj')
                ->name('site.executive_board.euripedes_rdnj');
            Route::get('diretoria-executiva/carlos-alberto-honorato-da-silva', 'Site\SiteController@executiveBoardCarlosAHS')
                ->name('site.executive_board.carlos_honorato');
            Route::get('beneficiarios', 'Site\SiteController@recipient')
                ->name('site.recipient');
            Route::get('relatorios-de-gestao', 'Site\SiteController@managementReport')
                ->name('site.management_report');
            Route::get('demostrativos-financeiros', 'Site\SiteController@financialStatement')
                ->name('site.financial_statement');
            Route::get('credenciado', 'Site\SiteController@accreditation')
                ->name('site.accreditation');
            Route::get('ouvidoria', 'Site\SiteController@ombudsman')
                ->name('site.ombudsman');
            Route::get('rede-reciprocidade', 'Site\SiteController@reciprocityNetwork')
                ->name('site.reciprocity_network');
            Route::get('reembolso', 'Site\SiteController@refund')
                ->name('site.refund');
            Route::get('substituicao-de-prestadores', 'Site\SiteController@providerReplacement')
                ->name('site.provider_replacement');
            Route::get('formularios-beneficiarios', 'Site\SiteController@beneficiaryForm')
                ->name('site.beneficiary_form');
            Route::get('central-de-atendimento', 'Site\SiteController@callCenter')
                ->name('site.call_center');
            Route::get('guia-medico', 'Site\SiteController@medicalGuide')
                ->name('site.medical_guide');
            Route::get('coronavirus', 'Site\SiteController@coronavirus')
                ->name('site.coronavirus');
            Route::get('segunda-via-do-boleto', 'Site\SiteController@duplicateBillet')
                ->name('site.duplicate_billet');
            Route::get('lgpd', 'Site\SiteController@lgpd')
                ->name('site.lgpd');
            Route::get('assembleia-geral-extraordinaria', 'Site\SiteController@extraordinaryGeneralMeeting')
                ->name('site.extraordinary_general_meeting');
        ...
        // Pesquisas
            ...
            // Pesquisas Completas
                ...
                Route::get('pesquisa-nao-disponivel',
                    'Site\Evaluation\CompletedEvaluationController@notAuthorized')
                    ->name('site.completed_evaluations.not_authorized');
            // Pesquisas Completas
